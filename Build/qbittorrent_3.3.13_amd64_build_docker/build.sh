...
docker cp $ID:/home/build/qbittorrent-3.3.13-opt.deb $HOME/$ContainerName-share/qbittorrent-3.3.13-opt.deb
docker cp $ID:/home/build/qbittorrent-3.3.13-opt.deb.md5 $HOME/$ContainerName-share/qbittorrent-3.3.13-opt.deb.md5
echo "go and checksum check"
cd "$HOME/$ContainerName-share"
md5sum -c qbittorrent-3.3.13-opt.deb.md5
